...
#define LAST_PRINTABLE_CHAR ((char)126)
    ...
    class CSpriteFont {
    public:
        CSpriteFont(const char* font, int size, char cs, char ce);
        CSpriteFont(const char* font, int size) :
            CSpriteFont(font, size, FIRST_PRINTABLE_CHAR, LAST_PRINTABLE_CHAR) {
        }
        ...
        void Draw(CSpriteBatch& batch, const char* s, glm::vec2 position, glm::vec2 scaling, 
